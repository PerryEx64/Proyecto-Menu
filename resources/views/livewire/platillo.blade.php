<div class="mockup-window border border-base-300">
    <div class="grid flex justify-center px-4 py-5 bg-base-200 ">
        ...
        <div class="form-control w-full max-w-xs">
            ...
            <select wire:model="tipo_platillo" class="select select-bordered">
        ...
        <div class="form-control">
            ...
            <textarea wire:model="guarniciones" class="textarea textarea-bordered h-24" placeholder="Escribe Aqui">{{$guarniciones}}</textarea>
        </div>
